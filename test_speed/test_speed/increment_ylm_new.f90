...
!vb end
      ...
      real*8 ::  sqrt3 , pisqrt_invv_2, c_2
      parameter(sqrt3 = 1.73205080756887729352744634151d0 )   
      parameter(pisqrt_invv_2 = 0.282094791773878143474039725780d0) 
      parameter(c_2 = 0.488602511902919921586384622838d0)
!
...
!
         ...
         TEMP1 = -LMtable(2*L+1)/LMtable(2*L)*SINTH
...
!
            TEMP1 = 1.0D+0/LMtable((L+M)*(L-M))
            TEMP2 = D4LL1C*TEMP1
            TEMP3 = D2L13*LMtable((L+M-1)*(L-M-1))*TEMP1
